...
class TestBaseModel(unittest.TestCase):
    ...
    def test_base_model_created_at_has_type_datetime(self):
        """
        ...
        self.assertIsInstance(
            self.model2.created_at, datetime)

    def test_base_model_updated_at_has_type_datetime(self):
        """
        ...
        """
        self.assertIsInstance(
            self.model3.updated_at, datetime)
    ...
    def test_base_model_has_valid_uuid(self):
        ...
        Returns:
            None
        """
        uuid_obj = uuid.UUID(self.model1.id)
    ...
    def test_str_method(self):
        ...
        model1_string = self.model1.__str__()
        self.assertTrue(type(model1_string), str)
        self.assertIsNotNone(model1_string)
        self.assertIn("id", model1_string)
        self.assertIn("created_at", model1_string)
        self.assertIn("updated_at", model1_string)
        self.assertIn("[BaseModel]", model1_string)

    def test_to_dict_method(self):
        """Test return value of the the to_dict method of BaseModel class"""
        test_dictionary = {k: v for k, v in self.model1.__dict__.items()}
        test_dictionary["created_at"] = self.model1.created_at.isoformat()
        test_dictionary["updated_at"] = self.model1.updated_at.isoformat()
        test_dictionary["__class__"] = self.model1.__class__.__name__
        self.assertEqual(test_dictionary, self.model1.to_dict())
